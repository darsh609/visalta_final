      ...
      <div className="space-y-4">
        ...
        >
          ...
          <input
            ...
            required
            className="w-full px-10 py-3 md:py-4 bg-gray-900 text-white rounded-lg border border-[#1db954]/30 focus:border-[#1db954] focus:ring-2 focus:ring-[#1db954]/20 transition-all duration-300"
          />
        </motion.div>
