      ...
      {loading ? (
        ...
        >
          ...
          >
            ...
            <motion.p
              className="text-[#1db954] text-sm md:text-base italic font-medium"
            ...
            <div>
              ...
              <div className="relative flex items-center bg-gray-800 rounded-md px-3 py-2 md:px-4 md:py-3">
                <input
                  ...
                  className="flex-1 bg-transparent border-none text-white outline-none text-xs md:text-sm"
                />
                <span
          ...
          <div className="mt-4 text-gray-300 flex justify-center gap-2 items-center">
            <Link
              to="/login"
              className="flex items-center gap-2 text-[#1db954] hover:text-[#1aaa4c] transition-colors duration-300 text-xs md:text-sm"
            >
              <BiArrowBack />
              Back to Login
            </Link>
