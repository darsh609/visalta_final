...
// //   useEffect(() => {
// //     if (activeFilters.length === 0) {
// //       return; // No need to filter if no active filters
// //     }
...
//   const [filteredRestaurants, setFilteredRestaurants] = useState([]); // Store filtered results
//   const [searchTerm, setSearchTerm] = useState("");
//   const [activeFilters, setActiveFilters] = useState([]);
//   const [showSearchResults, setShowSearchResults] = useState(false);
//   const [showFilters, setShowFilters] = useState(false);
...
//       const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/restraunts/get`);
//       const transformedData = response.data.map(restaurant => ({
//         id: restaurant._id, // Make sure to include the ID
//         Name: restaurant.name,
//         Timing: restaurant.openingHours,
//         Img: restaurant.imageUrl,
//         filters: restaurant.categories,
...
//   // Rest of the existing effects and handlers...
//   useEffect(() => {
//     if (activeFilters.length === 0) {
//       setFilteredRestaurants(allRestaurants);
//       return;
